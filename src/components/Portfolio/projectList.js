...
export const projectList = [
    ...
    },
    {
        ...
        description: "During my senior year of college, I led two other classmates in performing data analysis and modeling on United States Stock Market Data. Using a random forest classifier, we were able to predict whether the price of an individual stock would increase or decrease on the following day. Ultimately, we acheived above a 50% precision rate with our model for the three stock tickers we chose to investigate.",
    ...
    },
    {
        ...
        description: "During my senior year of college, I led three other CS majors on a design project. Our client asked us to create a new method for inputting digital mathematical notation, aiming to replace the current solution: LaTeX. We created a program that parses user input, identifies math notation between the given delimiters, and outputs text containing neatly formatted math equations. The Alpha version is built into a simple static website and is capable of interpreting English, Spanish, and Chinese inputs, all while producing an accessible output that can be utilized by screen-reading tools.",
